        ...
        <Row>
          ...
          <Col span={9} style={{}}>
            <div className='Left_bottom_container'>
              <TextArea rows={14} placeholder='request url and body (bash)' value={requestBashText} onChange={(e) => {setRequestBashText(e.target.value)}} allowClear />
